    ...
    try {
      ...
      if (status === 'payée') {
        ...
        if (invoice?.items) {
          ...
          // Marquer les daily_services inclus comme inactifs
        ...
        // Recharger l'historique du timer (pour retirer les sessions payées)
        if (reloadTimerSessions) reloadTimerSessions()
        // Recharger les données client dans le formulaire
        if (invoice?.client_id) loadClientData(invoice.client_id)
      }
