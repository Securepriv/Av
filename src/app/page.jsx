...
const Invoices = ({ T }) => {
  ...
  const htTotal = invoiceMode === 'hours' ? (hoursAmount + dsAmount) : freeTotal
...
export default function App() {
  ...
  const pages = { dashboard: <Dashboard setPage={setPage} user={user} T={T} />, clients: <Clients T={T} setPage={setPage} />, paidwork: <PaidWork T={T} />, timer: <Timer T={T} timerState={timerState} timerActions={timerActions} />, invoices: <Invoices T={T} />, quotes: <Quotes T={T} />, settings: <Settings user={user} T={T} theme={theme} setTheme={setTheme} /> }
